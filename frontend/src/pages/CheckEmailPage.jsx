...
const CheckEmailPage = () => {
    ...
    const openPreview = () => {
        ...
        navigate(`/email-preview?${query.toString()}`);
    };
            ...
            <div className="card bg-base-100 w-full max-w-lg shadow">
                <div className="card-body space-y-4">
                    ...
                    <button
                        ...
                        disabled={!token}
                    >
                        Open demo verification email
                    </button>

                    <p className="text-xs text-base-content/60 text-center">
                        {token ? "This preview will let you finish verification inside the app." : "Demo preview is unavailable for this session."}
                    </p>
